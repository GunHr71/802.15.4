...
******************************************************************************/
void App_SendSensorStatus(uint8_t Counter)
{   
    ...
    {       
        ...
        mpPacket->msgData.dataReq.pMsdu[1] = Counter; //COUNTER
        mpPacket->msgData.dataReq.pMsdu[2] = dummyToggleStatus; //SHORT ADDRESS LP
        mpPacket->msgData.dataReq.pMsdu[3] = dummyTemperature;	//SHORT ADDRESS HP
        mpPacket->msgData.dataReq.pMsdu[4] = (uint8_t)dummyAccelData[0]; //LINK QUALITY
        mpPacket->msgData.dataReq.pMsdu[5] = (uint8_t)dummyAccelData[1]; //PAYLOAD
