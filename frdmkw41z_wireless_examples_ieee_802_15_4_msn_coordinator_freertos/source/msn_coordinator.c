  ...
  switch(pMsgIn->msgType)
  {
   ...
   //   pMsgIn->msgData.dataInd.srcAddr = nodes_array[0].short_address;
      if (pMsgIn->msgData.dataInd.pMsdu[0] == 0xFF)
      {
        ...
        // Sensor data message
    	  Serial_Print(mInterfaceId," Counter Received:", gNoBlock_d);
    	  Serial_PrintHex(mInterfaceId,(uint8_t*)&pMsgIn->msgData.dataInd.pMsdu[1], 1, 0);
    	  
//    	  Serial_Print(mInterfaceId," Short Address:", gNoBlock_d);
...
//    	  Serial_PrintHex(mInterfaceId,(uint8_t*)&pMsgIn->msgData.dataInd.pMsdu[3], 1, 0);
    	  ...
    	  Serial_Print(mInterfaceId," LQI:", gNoBlock_d);
    	  Serial_PrintHex(mInterfaceId,(uint8_t*)&pMsgIn->msgData.dataInd.mpduLinkQuality, 1, gPrtHexNoFormat_c);
    	  
    	  Serial_Print(mInterfaceId," Payload:", gNoBlock_d);
    	  Serial_PrintHex(mInterfaceId,(uint8_t*)&pMsgIn->msgData.dataInd.msduLength, 1, gPrtHexNoFormat_c);
//
